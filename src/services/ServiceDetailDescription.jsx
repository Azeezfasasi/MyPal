                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="lg:w-2/3">
                        ...
                        <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4 mb-8">
                            <button className="w-full sm:w-auto px-8 py-5 rounded-[10px] bg-[#DB3A06] text-white font-semibold shadow-md hover:bg-orange-700 transition-colors duration-200 gap-2.5 cursor-pointer">
                                Download App to Book Service
                            </button>
                            <button className="w-full sm:w-auto p-5 rounded-[10px] border border-solid border-[#DB3A06] text-[#DB3A06] font-semibold hover:bg-gray-100 transition-colors duration-200 cursor-pointer">
                                Write a Review
                            </button>
                        ...
                        <div className="bg-white rounded-[10px] p-6 md:p-8 shadow-xl border border-solid border-gray-300 mb-8">
                            <h3 className="text-2xl md:text-2xl font-semibold text-[#000000] mb-6">
                                Service Offered
                            </h3>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                {serviceFeatures.map((service, index) => (
                                    <div key={index} className="flex items-center space-x-2 text-gray-700">
                                        ...
                                        <span className="text-[#000000] text-base font-normal">{service}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-[10px] p-6 md:p-8 border border-solid border-gray-300">
                            ...
                            <div className="space-y-3">
                                {businessHours.map((item, index) => (
                                    <div key={index} className="flex justify-between text-[#000000] text-[15px]">
                            ...
                            {/* Download Button */}
                            <div className="mt-8">
                                <button className="w-full p-5 rounded-[10px] bg-[#DB3A06] text-[#FBEBE6] text-base font-semibold hover:bg-orange-700 transition-colors duration-200 flex flex-row gap-2.5 items-center justify-center cursor-pointer">
                                    Download App to Book Service
                                </button>
                            </div>
                        </div>
