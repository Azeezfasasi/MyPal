...
export default function BusinessHeroSection() {
    return (
        <div className="relative w-full h-[800px] md:h-[861px] relative">
            ...
            <img
                className="rounded-b-[40px] h-[800px] md:h-[861px] absolute left-0 top-0"
                style={{
            ...
            <div className=" z-10 flex flex-col items-center justify-center h-full text-white px-4 md:px-8 relative">
                ...
                <div className="w-full md:w-[95%] flex flex-col gap-4 items-center justify-start mt-[-120px] md:mt-[-160px] mb-16">
                    ...
                    <button className="w-full md:w-[40%] lg:w-[20%] px-10 py-3 md:py-4 bg-[#DB3A06] hover:bg-orange-700 text-white font-semibold rounded-[10px] transition-colors duration-300 shadow-lg cursor-pointer text-2xl font-medium mt-6">
                        Get Started
                    </button>
                </div>
