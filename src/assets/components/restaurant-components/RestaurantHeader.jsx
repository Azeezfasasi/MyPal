            ...
            <header className="bg-transparent px-2 md:px-6 py-4">
                <div className="w-[95%] mx-auto flex justify-between items-center">
                    ...
                    <div className="hidden lg:flex flex-row gap-[18px] items-center justify-start relative">
                        <Link to="/" className="text-[#ffffff] text-left font-['AvenirNextRoundedStd-Medium',_sans-serif] text-lg font-medium relative flex items-center justify-start">
                            Login
                        </Link>
                        <Link to="/" className="bg-[#DB3A06] rounded-[40px] p-5 flex flex-row gap-2.5 items-center justify-center shrink-0 relative">
